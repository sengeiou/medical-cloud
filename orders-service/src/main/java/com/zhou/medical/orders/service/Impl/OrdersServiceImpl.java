package com.zhou.medical.orders.service.Impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.zhou.medical.common.entity.order.Orders;
import com.zhou.medical.common.jiuzhoutong.*;
import com.zhou.medical.common.redis.Constants;
import com.zhou.medical.common.redis.RedisUtil;
import com.zhou.medical.dao.service.Impl.GenericServiceImpl;
import com.zhou.medical.orders.service.IOrdersService;
import easemob.server.comm.HttpToEasemobUtil;
...
public class OrdersServiceImpl extends GenericServiceImpl<Orders, Integer> implements IOrdersService {
	...
	public void updateOrders(Orders orders) {
		...
		//患者头像
		String headUrl = "";
		headUrl = (String) redisUtil.get(Constants.KEY_HEADURL_PATIENT + orders.getPatientPhone());
		...
		ext.put("type", "payTip");
		ext.put("nickName", orders.getPatientName());
