...
public class ShuyuanUtils {
	...
	private static Log log = LogFactory.getLog(ShuyuanUtils.class);
	//Config.getProperty("shuyuanUrl", "");
	private static String URL = "http://api.shuyuanwl.com:8080/api/sms/send";
...
//            Map<Object, Object> map = (Map<Object, Object>) redisUtil.get(telphone);
			...
			if (map != null && !map.isEmpty()) {
                ...
                // 如果flagObject是null的话，就不转换
				if (null != codeObject && timeObject != null) {
