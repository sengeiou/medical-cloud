...
//	private static IJiuzhoutongLogService jiuzhoutongLogService = (IJiuzhoutongLogService) SpringConfigTool.getBean("jiuzhoutongLogService");
...
//				jiuzhoutongLogService.insert(jiuzhoutongLog);
			}catch(Exception e){
				e.printStackTrace();
			}
...
//				jiuzhoutongLogService.update("updateByPrimaryKeySelective", jiuzhoutongLog);
			}catch(Exception e){
				e.printStackTrace();
			}
		} catch (Exception e) {
