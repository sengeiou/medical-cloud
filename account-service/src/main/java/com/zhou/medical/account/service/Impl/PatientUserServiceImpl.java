...
import com.zhou.medical.account.service.IPatientUserService;
...
@Transactional
public class PatientUserServiceImpl extends GenericServiceImpl<PatientUser, Integer>
		implements IPatientUserService {
