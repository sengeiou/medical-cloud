...
<div id="toolbar" style="display: none;">
    ...
    <a onclick="downLoad();" href="javascript:void(0);" class="easyui-linkbutton"
       data-options="plain:true,iconCls:'icon-redo'">下载医生模版</a>
    <a id="batchImport" onclick="batchImport();" href="javascript:void(0);" class="easyui-linkbutton"
       data-options="plain:true,iconCls:'icon-mini-add'">批量导入医生</a>
</div>
<script type="text/javascript">
    if (<%=flag%>) {
